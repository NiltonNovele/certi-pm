...
import quizQuestions from "../data/new-pmp-complete";
...
const QUIZ_ID = "new-pmp-complete";
...
|
| Multiple-answer questions can use:
|
| answerType: "multiple"
| correctAnswer: ["Answer A", "Answer B"]
|
| Questions containing an image can use:
|
| image: "/quiz-images/pmp-complete/question-10.png"
|
| Questions without an image do not need the image property.
|
*/
...
const PmpComplete: React.FC = () => {
  ...
  */
  ...
  /*
   * Every question stores its selected answers
  ...
  */
  ...
  /*
   * Converts both answer formats into an array.
   *
   * "Answer A"
   *
   * becomes:
  ...
  /*
   * Checks whether the user's answers exactly
  ...
  */
  ...
  const handleAnswerChange = (
    ...
    /*
     * If answerType is omitted,
     * the question is treated as single-answer.
     */
            ...
            <div className="mx-auto flex min-h-[80vh] max-w-2xl items-center justify-center">
              <div className="w-full rounded-[32px] border border-gray-200 bg-white p-7 text-center shadow-xl sm:p-10">
                ...
                <p className="mx-auto mt-4 max-w-lg text-sm leading-7 text-gray-600 sm:text-base">
                  This complete PMP practice quiz
                  is available through the valid
                  promo code. Return to the quiz
                  library and enter your promo code
                  to unlock access.
                </p>
                  ...
                  <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="max-w-3xl">
                      ...
                      <p className="mt-3 max-w-2xl text-sm leading-7 text-gray-600 sm:text-base">
                        Practise against a complete PMP
                        question bank, track your progress,
                ...
                currentQuestion ? (
                  ...
                  <div className="p-5 sm:p-7 lg:p-8">
                    ...
                    {currentQuestion.scenario && (
                      <div className="rounded-2xl border border-red-100 bg-red-50 px-4 py-3 text-sm font-medium leading-7 text-red-700">
                    ...
                    {currentQuestion.image && (
                      <div className="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 p-2">
            ...
            <div className="w-full max-w-md rounded-[32px] border border-gray-200 bg-white p-6 shadow-xl sm:p-8">
              ...
              <div className="mb-6 text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-gray-600">
                  ...
                  your complete PMP practice quiz.
                </p>

              </div>

              <SignIn
                path="/new-pmp-complete"
                routing="path"
              />
