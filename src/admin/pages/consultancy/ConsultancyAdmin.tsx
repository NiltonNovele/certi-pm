...
const ConsultancyAdmin = () => {
  ...
  const openModal = (r: ConsultancyRequest) => {
    setSelected(r);
    setReply("");
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-xl shadow-lg w-full max-w-lg p-6">
            ...
            {selected.status === "NEW" && (
              <>
                <textarea
                  className="w-full border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-red-600 mb-3"
                  rows={6}
            ...
            {showPreview && (
              <div className="mt-4 bg-gray-100 p-3 rounded text-sm">
                ...
                <p>Hello {selected.fullName},</p>
                <p className="mt-2">{reply}</p>
                <p className="mt-2">— CertiPM</p>
              </div>
            )}
